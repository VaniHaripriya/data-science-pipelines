...
func SuccessfulPluginOutput(experimentID, experimentName, runID, runURL string) *apiv2beta1.PluginOutput {
	return buildPluginOutput(experimentID, experimentName, runID, runURL, apiv2beta1.RuntimeState_SUCCEEDED, "")
}

func FailedPluginOutput(experimentID, experimentName, runID, runURL, stateMessage string) *apiv2beta1.PluginOutput {
	return buildPluginOutput(experimentID, experimentName, runID, runURL, apiv2beta1.RuntimeState_FAILED, stateMessage)
}
...
func SetPluginOutputState(output *apiv2beta1.PluginOutput, state apiv2beta1.RuntimeState, stateMessage string) {
	if output == nil {
		return
	}
	output.State = state
...
func buildPluginOutput(experimentID, experimentName, runID, runURL string, state apiv2beta1.RuntimeState, stateMessage string) *apiv2beta1.PluginOutput {
